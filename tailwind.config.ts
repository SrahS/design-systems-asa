  ...
  theme: {
    extend: {
      colors: {
        ...
        'color-primary-50-on-light': '#FDFCFE',
        'color-primary-100-on-light': '#F9F4F6',
        'color-primary-200-on-light': '#F3EFE9',
        'color-primary-300-on-light': '#F0E5CC',
        'color-primary-400-on-light': '#F2ECC2',
        'color-primary-500-on-light': '#F0E0AF',
        'color-primary-600-on-light': '#E4B79D',
        'color-primary-700-on-light': '#E39886',
        'color-primary-800-on-light': '#EB623D',
        'color-primary-900-on-light': '#E3381B',

        // Tons primários (Dark)
        'color-primary-950-on-dark': '#322F26',
        'color-primary-960-on-dark': '#3F2D2E',
        'color-primary-970-on-dark': '#4F2E30',
        'color-primary-980-on-dark': '#602B30',
        'color-primary-990-on-dark': '#752A2D',
        'color-primary-dark-800-on-dark': '#A43A2F',
        'color-primary-dark-700-on-dark': '#B94D2C',
        'color-primary-dark-600-on-dark': '#C65D2C',
        'color-primary-dark-500-on-dark': '#D4682A',
        'color-primary-dark-400-on-dark': '#E76B26',
        'color-primary-default-on-dark': '#F7680A',
